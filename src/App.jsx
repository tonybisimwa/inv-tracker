...
// Split off the routes that carry the heavy dependencies — the OpenAI client
// (AddBet → SlipScanner) and the admin surface — so a first visit to the
// dashboard doesn't download them.
